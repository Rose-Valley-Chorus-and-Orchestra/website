          ...
          <div class="feature castlist">
               ...
               <h2 id="top" class="storyHead">Directors</h2>
                    ...
                    <h2 class="storyHead">Actors</h2>
                         ...
                         <li><span>J.B. Biggley</span> <span><at href="#Jeff">Jeff Swafford</a></span></li>
                         ...
                         <li><span>Ovington</span> <span><at href="#Bob">Robert Moore</a></span></li>
                         ...
                         <li><span>TV Host</span> <span><at href="#Bob">Robert Moore</a></li>
                         <li><span>Policeman</span><span><at href="#Bob">Robert Moore</a></li>
...
<div class="bios">
          ...
          <div class="listAlpha" ><span class="role">listed alphabetically</span></div>
           ...
           <!--              <p class="bios"><span class="headshot_img"><img src="../pirates2024/headshots/Meg.jpg" alt="Meg Averill headshot" class="headshot" /></span><a name="Meg"></a><span class="person">Meg Averill</span> (<span class="role">Daughter</span>)returns for her second production with RVCO and is thrilled to be part of this fabulous cast. Past theater ensemble experiences include <i>Fiddler on the Roof</i> (Players Club of Swarthmore), <i>High Society</i> (RVCO), Gilbert &amp; Sullivan's <i>Ruddigore</i> (Moore Family Singers in upstate NY) and <i>The Pirates of Penzance</i> (Players Club of Swarthmore), <i>Bells Are Ringing</i> (Y in Northeast Philadelphia), and <i>West Side Story</i> (The Wilma and PCS). She enjoys contra and latin dancing, playing the piano, traveling, cooking, and especially, spending time with her sons (who are in the 5-College area of western MA), her siblings (upstate NY), and her cousins and friends in the Philadelphia area. She is grateful to her parents, brother and sister for inspiring in her a lifelong passion for music and theater, and to her sons, who carry on that passion. <a href="#top" class="back2top">Back to top</a></p>
                         ...
                         <p class="bios"><span class="headshot_img"><img src="../pirates2024/headshots/Robert.jpg" alt="Robert Moore headshot" class="headshot"/></span><a name="Robert"></a><span class="person">Robert Moore</span> (<span class="role">Policeman/Pirate, Show Selection Chair, Make-Up Design</span>) is a proud RVCO Life Member since 1974, an actor and director, and the veteran of many productions of <i>The Pirates of Penzance</i>. He has directed the show for RVCO (as well as other groups) and played the Sergeant of Police in the previous RVCO production. He holds an MA in Theatre from Villanova University and has professional credits in film. theatre, and touring companies. He has directed countless shows for this group (the last being <i>Rodgers and Hammerstein's Cinderella</i>) and will be co-directing <i>Me and My Girl</i> in Spring 2025! In addition, he has created numerous principal roles in shows and has served on the Executive Board for many years. He is also on the Artistic Staff for the Next Generation Youth Theatre in Swarthmore. <a href="#top" class="back2top">Back to top</a></p> 
                         ...
                         <p class="bios"><span class="headshot_img"><img src="../pirates2024/headshots/Jeff.jpg" alt="Jeff Swafford headshot" class="headshot"/></span><a name="Jeff"></a><span class="person">Jeff Swafford</span> (<span class="role">Samuel, RVCO Board Member</span>) enjoys spending time with his RVCO family. Recent RVCO roles include <i>Rodgers &amp; Hammerstein's Cinderella</i> (King Maximillian), <i>Patience</i> (The Duke of Dunstable), <i>High Society</i> (Mike Connor), <i>H.M.S. Pinafore</i> (Dick Deadeye), <i>A Christmas Carol - The Musical</i> (Bob Cratchit), <i>Naughty Marietta, Revised 2018</i> and <i>The Mikado</i> (Ensemble), and with other local theaters, <i>South Pacific</i> (Stewpot), <i>Seussical the Musical</i> (Horton), <i>The Wizard of OZ</i> (Uncle Henry), and many moons ago, <i>The Pirates of Penzance</i> (The Pirate King). Jeff enjoys camping, the shore, Italian food, red wine, and hopes to revive his love of piano, ukulele, and photography. <a href="#top" class="back2top">Back to top</a></p>
