...
<link href="../test/css/bootstrap.css" rel="stylesheet" type="text/css">	
<link href="../test/css/multiColumnTemplate.css?v<?php echo date('his'); ?>" rel="stylesheet" type="text/css">
<link href="../test/css/multiColumn_Max425.css?v<?php echo date('his'); ?>" rel="stylesheet" type="text/css">
<link href="../test/css/multiColumn_Min426Max768.css?v<?php echo date('his'); ?>" rel="stylesheet" type="text/css">
<link href="../test/css/multiColumn_Min769Max1000.css?v<?php echo date('his'); ?>" rel="stylesheet" type="text/css">
<link href="../test/css/multiColumn_Min1001.css?v<?php echo date('his'); ?>" rel="stylesheet" type="text/css">
    ...
    <aside class="first_article">
		<div class="firstShow">
                    ...
                    <div class="show_authors">		
                         <div>Music by Aurthur Sullivan</div>
...
<!--
                       <div id="carousel1" class="carousel slide" data-ride="carousel" style="visibility:hidden;height: 0px;">
                            ...
                            <div class="carousel-inner" role="listbox">
                                 <div class="item active"><img src="patience2023/photos/duke_w_maiden300H.png" alt="First slide image" class="center-block" />
                                      <div class="carousel-caption">
                                           <p class="carousel-cap">Duke with a maiden</p>
                                           <p>Jeff and Kathy</p>
                                      </div>
                                 </div>
                                 <div class="item"><img src="patience2023/photos/dragoons300H.png" alt="Heavy Dragoons" class="center-block" />
                                      <div class="carousel-caption">
                                           <p class="carousel-cap">Heavy Dragoons</p>
                                           <p>Bob, Don, and Bruce</p>
                                      </div>
                                 </div>
                                 <div class="item"><img src="patience2023/photos/maidens300H.png" alt="Third slide image" class="center-block" />
                                      <div class="carousel-caption">
                                           <p class="carousel-cap">Beautiful Maidens</p>
                                           <p>Sally, Laura, Lisa, Sharon, and Faith</p>
                                      </div>
                                 </div>
                                 <div class="item"><img src="patience2023/photos/lady_jane300H.png" alt="Lady Jane" class="center-block" />
                                      <div class="carousel-caption">
                                           <p class="carousel-cap">Lady Jane</p>
                                           <p>Terry</p>
                                      </div>
                                 </div>
                                 <div class="item"><img src="patience2023/photos/bunthorn_patience300H.png" alt="Patience and Bunthorne" class="center-block" />
                                      <div class="carousel-caption">
