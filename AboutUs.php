...
<div id="content">
  ...
  <div id="aboutus"><img src="images/logo/red RVCO logo_small.webp" alt="" name="Picture8" id="rvcoLogo" class="img-responsive" style=" max-width: 200px;margin-left: auto;margin: 15px;"/>
