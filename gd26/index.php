...
<!-- end masthead -->
     ...
     <div id="content">
                              ...
                              <h2>Schedule</h2>
                                   ...
                                   <div class="castpageLinks" style="">
                                        ...
                                        <div id="HideLink" style="display:none;">
                                             ...
                                             <span id="pastDays">
                                                  <div><ul><b>Wednesday August 19</b>: 2 rooms
                                                            <ul class="day"><u>CALLED</u>: Rudolph, Ernest, Ludwig, Notary, Prince, Princess, Baroness, Julia, Lisa</ul>
                                                            <ul><u>BLOCKING: </u>
          ...
          <!-- XXXXXXXXXXXXXXXXXXXXXXXXXXXX begins remaining rehearsal dates below XXXXXXXXXXXXXXXXXXXXXXXXXXXX-->
                                        ...
                                        <div style="color: firebrick; background-color:lemonchiffon ; padding: 5px 0px 5px 0px; font-size: 0.85em;text-align: center;">
                                             <b>----- EVERYONE is called from this date forward -----</b></div>
                                        ...
                                        <div style="color: firebrick;background-color: yellow; padding: 5px 0px 5px 0px; font-size: 0.85em;text-align: center;">
                                             <b>----- EVERYONE OFF BOOK -----</b></div>                                   
